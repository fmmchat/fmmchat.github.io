...
window.onload = function() {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyAV2BSiAek4o-rtt4kXtEswozpOlhcTz5I",
    authDomain: "fmmchat.firebaseapp.com",
    projectId: "fmmchat",
    storageBucket: "fmmchat.appspot.com",
    messagingSenderId: "323898553254",
    appId: "1:323898553254:web:2bdca6a8e6fd3b89289567"
  };
  ...
  class FMMCHAT{
    ...
    create_join_form(){
      ...
      join_input.placeholder = 'Your Name... Or Be Anonymous'
        if(join_input.value.length == 0){
            join_input.value = `Anonymous`
        }else{
